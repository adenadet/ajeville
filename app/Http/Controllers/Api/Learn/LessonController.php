...
class LessonController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $this->validate($request, [
            'name' => 'required', 
            'course_id' => 'required', 
            'lesson_type_id' => 'required|exists:learn_lesson_types,id', 
            'file_type' => 'sometimes', 
            'file' => 'nullable', 
        ...
        $lesson = $this->learn_course_lesson_create($data);
    ...
    {
        $lesson = $this->learn_course_lesson_get_by(null, $id, true);
        return response()->json([
            'lesson' => $lesson,
        ], is_string($lesson) ? 404 : 200);  
        /*return response()->json([
            'certificate_types' => CertificateType::select('id', 'name')->orderBy('name', 'ASC')->get(),
            'categories' => Category::select('id', 'name',)->with('sub_categories')->orderBy('name', 'ASC')->get(),  
