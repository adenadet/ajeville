...
Route::namespace('Finance')->middleware('auth:api')->group(base_path('routes/api/emr/finance.php'));
...
Route::namespace('Settings')->middleware('auth:api')->group(base_path('routes/api/emr/settings.php'));