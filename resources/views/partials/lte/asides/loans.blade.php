<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">    
        <li class="nav-item">
            <a href="/loans/dashboard" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i><p>Dashboard</p></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="/loans/guarantors" class="nav-link"><i class="nav-icon fas fa-user-friends"></i><p>Guarantors</p></a>
        </li>
        <li class="nav-item">
