<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if(Auth::user()->can('Store Manager') || Auth::user()->hasRole('Super Admin'))
        ...
        <li class="nav-item has-treeview">
            ...
            @foreach($user_stores as $user_store)
                <li class="nav-item"><a href="/inventory/user_stores/{{$user_store->id}}" class="nav-link"><i class="fa fa-circle nav-icon"></i><p>{{$user_store->name}}</p></a></li>
            @endforeach
            </ul>
        </li>
        <li class="nav-item has-treeview">
        ...
        @if(Auth::user()->hasRole('Super Admin') || Auth::user()->can('inventory_management'))
        <li class="nav-item has-treeview">
