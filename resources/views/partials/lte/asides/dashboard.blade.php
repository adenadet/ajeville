<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                @if(Auth::user()->hasRole('EMR Admission') || Auth::user()->hasRole('Super Admin'))<li class="nav-item"><a href="/emr/admission" class="nav-link"><i class="mr-1 fas fa-bed"></i><p> Admission</p></a></li>@endif
                ...
                @if(Auth::user()->hasRole('EMR Pharmacy') || Auth::user()->hasRole('Super Admin'))<li class="nav-item"><a href="/emr/pharmacy" class="nav-link"><i class="mr-1 fa fa-pills"></i><p> Pharmacy</p></a></li>@endif
