        ...
        <table>
            <tr>
                <td>
                    ...
                    <p style="text-align: left;">The transaction: {{$transaction->title}} [{{$transaction->unique_code}}] has been successfully paid for.</p>
                    @if ($transaction->seller_id == $user->id)
                    <p>
                        Please proceed to fulfill the transaction.
                        <br />
