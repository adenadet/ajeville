        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <QuillEditor content-type="html" theme="snow" class="form-control" id="description" name="description" v-model:content="StoreData.description" :class="{'is-invalid' : StoreData.errors.has('description') }"></QuillEditor>
                </div>
            </div>
        </div>
...
export default {
    ...
    watch:{
        store(){
            this.StoreData.fill(this.store);
        }
    }
}
</script>