...
import EMRAdmissionWards                    from    '../emr/admission/Wards.vue';
    ...
    import EMRAdmissionDetailBedAssignment      from '../emr/admission/details/BedAssignment.vue';
    import EMRAdmissionDetailPrechecks          from '../emr/admission/details/Prechecks.vue';
    ...
    import EMRAdmissionFormAdmit                from '../emr/admission/forms/Admit.vue';
...
import EMRFinanceTransactions                   from '../emr/finance/Transactions.vue';
    ...
    import EMRFinanceDetailBillDetailed             from '../emr/finance/details/BillDetailed.vue';
    import EMRFinanceDetailBillSummary              from '../emr/finance/details/BillSummary.vue';
...
import EMRFrontOfficeVisits                     from '../emr/front_office/Visits.vue';
    ...
    import EMRFrontOfficeDetailTransactionList      from '../emr/front_office/details/TransactionList.vue';       
...
import EMRRadiologyRequest                      from '../emr/radiology/Request.vue';
    ...
    import EMRRadiologyFormAction                   from '../emr/radiology/forms/Action.vue';
    import EMRRadiologyFormReferral                 from '../emr/radiology/forms/Referral.vue';
    import EMRRadiologyFormRequest                  from '../emr/radiology/forms/Request.vue';

    import EMRSettingFormServiceSearch              from '../emr/visitations/forms/Search.vue';
...
export function registerGlobalComponents(app) {
    ...
    app.component('EMRAdmissionWards',                          EMRAdmissionWards);
        ...
        app.component('EMRAdmissionDetailBedAssignment',             EMRAdmissionDetailBedAssignment);
        app.component('EMRAdmissionDetailPrechecks',                 EMRAdmissionDetailPrechecks);
        ...
        app.component('EMRAdmissionFormAdmit',                       EMRAdmissionFormAdmit);
    ...
    app.component('EMRFinanceTransactions',             EMRFinanceTransactions);
        ...
        app.component('EMRFinanceDetailBillDetailed',           EMRFinanceDetailBillDetailed);
        app.component('EMRFinanceDetailBillSummary',            EMRFinanceDetailBillSummary);
        ...
        app.component('EMRFinanceDetailTransaction',            EMRFinanceDetailTransaction);
    ...
    app.component('EMRFrontOfficeVisits',                   EMRFrontOfficeVisits),
        ...
        app.component('EMRFrontOfficeDetailTransactionList',    EMRFrontOfficeDetailTransactionList);    
    ...
    app.component('EMRRadiologyRequest',                    EMRRadiologyRequest);
    
        app.component('EMRRadiologyDetailReferralList',         EMRRadiologyDetailReferralList);
        app.component('EMRRadiologyDetailRequest',              EMRRadiologyDetailRequest);
        app.component('EMRRadiologyDetailRequestList',          EMRRadiologyDetailRequestList);
        
        app.component('EMRRadiologyFormAction',                 EMRRadiologyFormAction);
        app.component('EMRRadiologyFormReferral',               EMRRadiologyFormReferral);
        app.component('EMRRadiologyFormRequest',                EMRRadiologyFormRequest);
      
        app.component('EMRSettingFormServiceSearch',            EMRSettingFormServiceSearch);
