...
<section class="overlay-wrapper">
    ...
    <div class="modal fade" id="uploadCustomerModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h4 class="modal-title" v-show="!editMode">Upload Customer</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="text-white">&times;</span></button>
                </div>
                <div class="modal-body">
                    <CRMFormCustomerUpload @customerFormReload="getAllInitials"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <CRMDetailCustomerList :customers="customers.data" view="crm" @customerReload="getAllInitials" />
                </div>
