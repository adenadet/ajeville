...
export default {
    ...
    methods:{
        createCustomer(){
            this.loading = true;
            this.customerData.post('/api/crm/customers')
            .then(response =>{
                this.loading = false;
                this.$emit('customerFormReload', response);
                this.$swal.fire({
                    icon: 'success',
        ...
        getInitials(){
            this.loading = true;
            axios.get('/api/crm/customers/initials')
            .then(response =>{
        ...
        updateCustomer(){
            this.loading = true;
            this.customerData.put('/api/crm/customers/'+this.customerData.id)
            .then(response =>{
                this.loading = false;
                this.$emit('customerFormReload');
                this.$swal.fire({
                    icon: 'success',
