...
<section class="overlay-wrapper">
    <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
            Patient: 
            <address>
            <strong>{{ consultation.patient != null ? consultation.patient.user : '' }}</strong><br>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <b>Complaint:</b>
            <div class="bordered" v-html="consultation.complaint"></div>
        </div>
        <div class="col-md-6">
            <b>History:</b>
            <div class="bordered" v-html="consultation.history"></div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 table-responsive" v-if="consultation.plan != null">
            <table class="table table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="5"><spsn v-if="consultation.plan.intent.referral">Referral Issued</spsn></td>
                    </tr>   
                </tbody>
            </table>
        </div>
    ...
    <div class="row" v-if="consultation.requests != null">
        ...
        <b>Further Treatment</b>
            <div class="col-md-6">
                <table class="table table-striped" v-if="consultation.request.laboratory != null && consultation.request.length > 0">
                    <thead>
                        <tr>
                            <th>Name </th>
                            <th>Category </th>
        ...
        <div class="col-12 table-responsive" v-if="consultation.requests.prescription != null && consultation.requests.prescription.length > 0">
