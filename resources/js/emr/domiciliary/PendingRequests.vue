            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pending Domiciliary Services</h3>
                    ...
                    <div class="card-body table-responsive p-0" style="min-height: 500px;">
                        <table class="table table-hover table-striped table-header-fixed">
                            <thead>
                                <tr>
                                    <th>Patient</th>
                                    <th>Contact</th>
                            ...
                            <tbody v-else>
                                <tr v-for="domiciliary in domiciliaries.data" :key="domiciliary.id">
                                    ...
                                    <td>{{domiciliary.accessment != null ? 'Completed' : (domiciliary.assessor != null ? 'Ongoing': 'Not Assigned')}}<br />
