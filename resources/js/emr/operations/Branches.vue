        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body table-responsive p-0" style="height: 300px;">
                    <OperationDetailBranchList source="emr" :branches.sync="branches.data" :loading="loading" @refreshBranches="getInitials" />
                </div>
...
export default {
    data() {
        return {
            branch: {},
            branches: {data: [], total: 0, per_page: 0, current_page: 0},
            current_page: 1,
            loading: false,
            query: '',
        }
