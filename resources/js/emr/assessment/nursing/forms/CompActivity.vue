...
<section>
    <form>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Patient</label>
                    <input disabled type="text" class="form-control" :value="patient != null ? patient.last_name+', '+patient.first_name+' '+patient.middle_name : 'Loading Patient Data'" />
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <select type="text" required class="form-control" id="staff_id" name="staff_id" v-model="assessRequestForm.staff_id">
        ...
        <button @click.prevent="assignRequest()" type="submit" name="submit" class="submit btn btn-success">Submit</button>
    </form>
</section>
</template>
