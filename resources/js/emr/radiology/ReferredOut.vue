            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Referral Outs</h3>
                        <div class="card-tools">
                            <div class="input-group" style="width: 500px;">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <select v-model="status" class="form-control ml-3">
                    ...
                    <div class="card-body table-responsive p-0" style="height: 600px;">
                        <!--EMRRadiologyDetailReferralList :refferals.sync="referrals.data" view="out"/-->
                    </div>
...
export default {
    ...
    methods: {
        ...
        getInitials(page=1) {
            axios.get('/api/emr/radiology/refferals?page='+page+'&search='+this.search+'&status='+this.status+'&type=out')
            .then(response => {
