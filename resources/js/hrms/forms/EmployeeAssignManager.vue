    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <model-list-select v-model="employeeData.supervisor_id" :list="employees" optionValue="employee_id" placeholder="Select Supervisor/Exco Lead" :custom-text="codeAndNameAndDesc"></model-list-select>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>Line Manager</label>
                <model-list-select v-model="employeeData.reports_to" :list="employees" optionValue="employee_id" placeholder="Select Line Manager" :custom-text="codeAndNameAndDesc"></model-list-select>
            </div>
        </div>
    </div>
    <div class="row">
