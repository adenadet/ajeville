...
export default {    
    ...
    methods:{
        assignUsers(){
            ...
            .then(response=>{
                this.$swal.fire({icon: 'success',title: 'Use has been assigned!',});
                this.$emit('refreshAssignUser');
            })
            .catch(()=>{
        ...
        getInitials(){
            axios.get('/api/learn/assign_users/initials').then(response =>{
