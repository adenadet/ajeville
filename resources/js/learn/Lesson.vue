        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ editMode ? 'Edit Lesson: '+lesson.name : 'New Lesson'}}</h4>
                ...
                <div class="modal-body">
                    <LearnFormLesson :lesson.sync="lesson" :course.sync="course" :editMode="editMode" @refreshLessonForm="getAllInitials" />
                </div>
            </div>
        </div>
    </div>
