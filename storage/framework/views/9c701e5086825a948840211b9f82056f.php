<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if(Auth::user()->hasRole('Super Admin') || Auth::user()->can('procurement_management')): ?>
        <li class="nav-item has-treeview">
...
<?php /**PATH C:\wamp64\www\laravel10\ajeville\resources\views/partials/lte/asides/procurement.blade.php ENDPATH**/ ?>