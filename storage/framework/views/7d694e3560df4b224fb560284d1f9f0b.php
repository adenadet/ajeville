<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php endif; ?>
        <?php if(Auth::user()->hasRole('Coor') || Auth::user()->hasRole('Super Admin')): ?>
        <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <?php if(Auth::user()->hasRole('Coop Staff') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/coop/dashboard" class="nav-link"><i class="fas fa-piggy-bank nav-icon"></i><p>Cooperator</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('Coop Admin') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/coop_admin/dashboard" class="nav-link"><i class="fas fa-user-cog nav-icon"></i><p>Admin</p></a></li><?php endif; ?>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                ...
                <?php if(Auth::user()->hasRole('EMR Managed Care') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/emr/managed_care" class="nav-link"><i class="mr-1 fas fa-file-alt"></i><p> Managed Care</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('EMR Nurse') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/emr/nursing" class="nav-link"><i class="mr-1 fas fa-user-nurse"></i><p> Nursing Care</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('EMR Pharmacy') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/emr/pharmacy" class="nav-link"><i class="mr-1 fa fa-pills"></i><p> Pharmacy</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('EMR Operations') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/emr/operations" class="nav-link"><i class="mr-1 fas fa-cogs"></i><p> Operations</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('EMR Radiology') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/emr/radiology" class="nav-link"><i class="mr-1 fas fa-x-ray"></i><p> Radiology</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('EMR Records') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/emr/records" class="nav-link"><i class="mr-1 fas fa-file-medical"></i><p> Records</p></a></li><?php endif; ?>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <?php if(Auth::user()->hasRole('Escrows') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/escrows" class="nav-link"><i class="nav-icon fas fa-money-check"></i><p>Escrows</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('Escrow Admin') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/escrow_admin" class="nav-link"><i class="nav-icon fas fa-money-check"></i><p>Admin </p></a></li><?php endif; ?>
            </ul>
        </li>
        <?php endif; ?>
        <?php if(Auth::user()->hasRole('Finances') || Auth::user()->hasRole('Super Admin')): ?>
        <li class="nav-item"><a href="/finance" class="nav-link"><i class="nav-icon fas fa-money-bill-wave"></i><p>Finances</p></a></li>
        <?php endif; ?>
        <?php if(Auth::user()->hasRole('Human Resources') || Auth::user()->hasRole('Super Admin')): ?>
        <li class="nav-item has-treeview">
            <a href="#" class="nav-link"><i class="nav-icon fas fa-users-cog"></i><p>Human Resources <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
                <?php if(Auth::user()->hasRole('HR Staff') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/hrms/dashboard" class="nav-link"><i class="fas fa-user nav-icon"></i><p>Staff</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('HR Admin') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/hrms_admin/dashboard" class="nav-link"><i class="fas fa-user-cog nav-icon"></i><p>Admin</p></a></li><?php endif; ?>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <?php if(Auth::user()->hasRole('Learn User') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/learn/student/dashboard" class="nav-link"><i class="fas fa-chalkboard nav-icon"></i><p>Student Area</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('Learn Tutor') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/learn/tutor/dashboard" class="nav-link"><i class="fas fa-chalkboard-teacher nav-icon"></i><p>Tutor Area</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('Learn Admin') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/learn/admin/dashboard" class="nav-link"><i class="fas fa-user-cog nav-icon"></i><p>Admin Area</p></a></li><?php endif; ?>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <?php if(Auth::user()->hasRole('Loans Customer') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/loans/dashboard" class="nav-link"><i class="fas fa-user-circle nav-icon"></i><p>Customer Area</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('Loans Staff') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/loans_staff/dashboard" class="nav-link"><i class="fas fa-house-user nav-icon"></i><p>Staff Area</p></a></li><?php endif; ?>
                <?php if(Auth::user()->hasRole('Loans Admin') || Auth::user()->hasRole('Super Admin')): ?><li class="nav-item"><a href="/loans_admin/dashboard" class="nav-link"><i class="fa fa-user-cog nav-icon"></i><p>Admin Area</p></a></li><?php endif; ?>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if(Auth::user()->hasRole('Sales Orders') || Auth::user()->hasRole('Super Admin')): ?>
        <li class="nav-item"><a href="/sales_orders" class="nav-link"><i class="nav-icon fas  fa-cash-register"></i><p>Sales Orders</p></a></li>
        <?php endif; ?>
        <?php if(Auth::user()->hasRole('Users') || Auth::user()->hasRole('Super Admin')): ?>
        <li class="nav-item"><a href="/users" class="nav-link"><i class="nav-icon fa fa-users"></i><p>Users</p></a></li>
        <?php endif; ?>
    </ul>
</nav><?php /**PATH C:\wamp64\www\laravel10\ajeville\resources\views/partials/lte/asides/dashboard.blade.php ENDPATH**/ ?>